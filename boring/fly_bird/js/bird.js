...
var s = {
	...
	bh:29,//鸟的高
	y : 0,//鸟的top值
	arrl:[],//记录li的left值，以及上下柱子上下沿的top值,柱子是否已经飞过true和false表示
	cw:62,	//柱子宽度
	scores : 0	//分数
}
//开始游戏
...
function createCol(){
	s.createTimer = setInterval(function(){
		...
		var topcol = document.createElement("div");  //生成上部
		...
		var botcol = document.createElement("div");   //生成下部
